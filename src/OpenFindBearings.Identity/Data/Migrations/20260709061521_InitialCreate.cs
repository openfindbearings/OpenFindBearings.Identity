        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_StreetAddress = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Address_Locality = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OidcApplications_TenantId",
                table: "OidcApplications",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_OidcAuthorizations_ApplicationId",
                table: "OidcAuthorizations",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_OidcAuthorizations_TenantId",
                table: "OidcAuthorizations",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_OidcScopes_TenantId",
                table: "OidcScopes",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_OidcTokens_ApplicationId",
                table: "OidcTokens",
                column: "ApplicationId");
